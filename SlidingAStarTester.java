...
public class SlidingAStarTester
{
    ...
    public static void main(String[] args) throws IOException
    {
	  ...
	  System.out.println("*       (Uses the A* Heuristic)         *");
      System.out.println("*****************************************");
        ...
        if (userIn.equalsIgnoreCase("quit")) //if user typed quit, stops program
          break;
              ...
              try
              {
                ...
                System.out.println("Sliding A* Output for " + userIn);
                System.out.println("(" + size + " x " + size + " Board)");
				System.out.println(" ");

                PWOut.println("Sliding A* Output for " + userIn);
                PWOut.println("(" + size + " x " + size + " Board)");
				PWOut.println(" ");

                //Creating new SlidingAStar object of SlidingAStar class with parameters
                //read in from files
                SlidingAStar sA = new SlidingAStar(initialBoard, finalBoard, size, PWOut);
                sA.timedSolve(); //starting solve method
